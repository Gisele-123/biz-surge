...
import { idlFactory } from './ideas.did.js';
export { idlFactory } from './ideas.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IDEAS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ideas.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ideas canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ideas.did.js")._SERVICE>}
 */
export const ideas = createActor(canisterId);
